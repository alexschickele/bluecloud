...
In other words, we are able to model the biogeography of CCs related to a given metabolic pathways. **These data are stored in a PostgreSQL database, accessed during the first step of the modeling pipeline.**
